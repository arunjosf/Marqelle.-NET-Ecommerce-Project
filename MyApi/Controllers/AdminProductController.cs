...
namespace Marqelle.Api.Controllers
{
    ...
    public class AdminProductController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddProduct([FromForm] AdminAddproductDto dto)
        {
            ...
            var productId = await _service.AddProductAsync(dto);
            ...
            [FromBody] AddStockDto dto)
        {
            ...
            await _service.AddStockAsync(productId, dto);

            return Ok(new ApiResponseDto<object>(
                StatusCodes.Status200OK, true, "Stock added successfully.", null));
        }
        ...
        public async Task<IActionResult> UpdateProduct(
            [FromQuery] long productId,
            [FromForm] AdminUpateProductDto dto)
        {
            if (!ModelState.IsValid)
            {
                var errors = ModelState.Values
            ...
            [FromBody] AddStockDto dto)
        {
            ...
            await _service.UpdateStockAsync(productId, dto);

            return Ok(new ApiResponseDto<object>(
                StatusCodes.Status200OK, true, "Stock updated successfully.", null));
        }
